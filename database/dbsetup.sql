...
(
    U_ID INT NOT NULL,
    R_ID varchar(1024) NOT NULL,
    H_DATE DATETIME NOT NULL DEFAULT NOW(),
    PRIMARY KEY(U_ID, R_ID, H_DATE),
    FOREIGN KEY(U_ID) REFERENCES USERS(U_ID),
    FOREIGN KEY(R_ID) REFERENCES RESTAURANTS(R_ID)
);
...
(
    U_ID INT NOT NULL,
    U_DISTANCE INT NOT NULL,
    U_CATEGORIES varchar(1024),
    PRIMARY KEY(U_ID),
    FOREIGN KEY(U_ID) REFERENCES USERS(U_ID)
);
...
INSERT INTO PREFERENCES (U_ID, U_DISTANCE, U_CATEGORIES) VALUES (1, 5000, 'sushi');
INSERT INTO PREFERENCES (U_ID, U_DISTANCE) VALUES (2, 5000);
...
INSERT INTO HISTORY (U_ID, R_ID, H_DATE) VALUES (1, 'dovujn6osuLTfytLf5eDGw', '2018-11-20 10:09:34');
INSERT INTO HISTORY (U_ID, R_ID, H_DATE) VALUES (1, 'dovujn6osuLTfytLf5eDGw', '2018-11-20 10:10:13');
INSERT INTO HISTORY (U_ID, R_ID, H_DATE) VALUES (1, 'tc4LQ_GQGt8qLdFKH2qNVQ', '2018-11-20 10:10:13');

/*
Get all the favorites:

select USERS.U_ID, U_FIRST_NAME, RESTAURANTS.R_ID, R_NAME from FAVORITES
    inner join USERS
        on FAVORITES.U_ID = USERS.U_ID
    inner join RESTAURANTS
        on FAVORITES.R_ID = RESTAURANTS.R_ID
order by U_ID;

Get the history:

select USERS.U_ID, U_FIRST_NAME, RESTAURANTS.R_ID, R_NAME, H_DATE from HISTORY
    inner join USERS
        on HISTORY.U_ID = USERS.U_ID
    inner join RESTAURANTS
        on HISTORY.R_ID = RESTAURANTS.R_ID
order by H_DATE;
*/
